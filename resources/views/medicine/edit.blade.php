      ...
      <h2>Update Drug</h2><br  />
        ...
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            <input type="text" size="32" maxlength="32" class="form-control" name="status" value="{{$med->status}}">
          </div>
          <div class="form-group col-md-3">
          ...
          <div class="form-group col-md-3">
            ...
            <input type="text" size="32" maxlength="80" class="form-control" name="precautions" value="{{$med->precautions}}">
          </div>
        </div>
        <div class="row">
