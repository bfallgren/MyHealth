 ...
 <div class="container">
    ...
    <div class=topPage>
        ...
        <form method="GET" action="/Labs" style=float:right>
          ...
          <input type="text" name="compName" placeholder="Component">
          <input title='Component' data-toggle='tooltip' type="submit" class="btn btn-info" value="Filter"/>
        ...
        {{ $lab->appends(compact('items'))->onEachSide(1)->links() }} 
    ...
    <div class="table-responsive">
        <table class="table" style="border:none border-collapse:collapse">
            <tr style="color:red">
                ...
                <th width="90px" class="sorting" data-sorting_type="asc" data-column_name="testDate" style="cursor: pointer">Test Date <span id="testDate_icon"></span></th>
                <th width="80px" class="sorting" data-sorting_type="asc" data-column_name="component" style="cursor: pointer">Component <span id="component_icon"></span></th>
            ...
            @if($lab->count())
                @foreach($lab as $lab)
                    <tr>
                        ...
                        <td>{{$lab['goodRange']}}</td>
                        <td><textarea readonly type="text" rows="3" cols="15" class="form-control" name="comments">{{$lab->comments}}</textarea></td>
