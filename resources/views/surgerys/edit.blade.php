      ...
      @endif
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="vitalsWeight" required value="{{$oper->vitalsWeight}}">
          </div>
          <div class="form-group col-md-4">
            <label for="vitalsBP">Blood Pressure:</label>
            <input type="text" class="form-control" name="vitalsBP" value="{{$oper->vitalsBP}}">
          </div>
        </div>
        <div class="row">
          <div class="col-md-12"></div>
