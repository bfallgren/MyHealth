...
<body>
 ...
 <div class="container">
    ...
    <form method="GET" action="/imaging" style=float:right> 
        ...
        {{ $img->appends(compact('items'))->onEachSide(1)->links() }}
        ...
        @if($img->count())
            @foreach($img as $img)
                <tr>
                    ...
                    <td><textarea readonly type="text" rows="3" cols="15" class="form-control" name="reason">{{$img->reason}}</textarea></td>
                    <td><textarea readonly type="text" rows="3" cols="15" class="form-control" name="reason">{{$img->diagnosis}}</textarea></td>
