      ...
      @endif
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4">
            ...
            <textarea type="text" size="80" maxlength="80" class="form-control" name="reason" id="ta_reason">{{$img->reason}}</textarea>
            <input type="hidden" id="rsnCharLength" value="{{ Str::length($img->reason) }}">
          ...
          <div class="form-group col-md-4">
            ...
            <textarea type="text" size="80" maxlength="512" class="form-control" name="diagnosis" id="ta_diag">{{$img->diagnosis}}</textarea>
            <input type="hidden" id="diagCharLength" value="{{ Str::length($img->diagnosis) }}">
